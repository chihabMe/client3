      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              <span className="text-2xl font-bold text-[#39ff14]">IPTV</span>
              <span className="text-2xl font-bold text-white">King</span>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              The ultimate streaming experience with unlimited entertainment options at your fingertips.
            </p>
          ...
          >
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#faq" className="hover:text-[#39ff14] transition-colors">FAQ</a></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-[#39ff14] transition-colors">DMCA</a></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-2 text-gray-400">
              <li>1234 Streaming Avenue</li>
              <li>New York, NY 10001</li>
              <li>support@iptvking.com</li>
        ...
        >
          <p className="text-gray-500 text-sm">
            © 2025 IPTV King. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-gray-500 hover:text-[#39ff14] text-sm">
              Privacy Policy
            </a>
            <a href="#" className="text-gray-500 hover:text-[#39ff14] text-sm">
              Terms of Service
