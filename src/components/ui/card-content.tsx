...
export default function ContentCard({ content }: { content: Content }) {
  return (
    <div className="bg-gray-900 rounded-lg overflow-hidden hover:ring-1 hover:ring-[#00ff2a] transition-all duration-300">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-1 mb-2">
          ...
          <span className="text-xs text-gray-400">{content.rating}</span>
        </div>
